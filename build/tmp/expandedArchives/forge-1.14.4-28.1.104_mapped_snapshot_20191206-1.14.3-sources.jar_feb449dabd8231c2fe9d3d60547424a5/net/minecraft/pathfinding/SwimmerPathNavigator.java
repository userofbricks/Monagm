...
public class SwimmerPathNavigator extends PathNavigator {
   ...
   protected void pathFollow() {
      if (this.currentPath != null) {
         ...
         // Forge: fix MC-94054
         if (Math.abs(this.entity.posX - (vec3d2.x + (this.entity.getWidth() + 1) / 2D)) < (double)f1 && Math.abs(this.entity.posZ - (vec3d2.z + (this.entity.getWidth() + 1) / 2D)) < (double)f1 && Math.abs(this.entity.posY - vec3d2.y) < (double)(f1 * 2.0F)) {
