...
public abstract class PathNavigator {
   ...
   protected void pathFollow() {
      ...
      // Forge: fix MC-94054
      if (Math.abs(this.entity.posX - (vec3d1.x + (this.entity.getWidth() + 1) / 2D)) < (double)this.maxDistanceToWaypoint && Math.abs(this.entity.posZ - (vec3d1.z + (this.entity.getWidth() + 1) / 2D)) < (double)this.maxDistanceToWaypoint && Math.abs(this.entity.posY - vec3d1.y) < 1.0D) {
         this.currentPath.setCurrentPathIndex(this.currentPath.getCurrentPathIndex() + 1);
      }
